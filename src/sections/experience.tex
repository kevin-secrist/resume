  ...
  \experience
    ...
    {December 2020} {
                      \begin{itemize}
                        ...
                        \item Worked across team boundaries to update \link{https://www.rackspace.com/sites/default/files/white-papers/Rackspace-Service-Overview-Service-Guide-for-Service-Blocks-Enterprise-Version-AZU-12621.pdf\#page=7}{Watchman} (owned by a different team) to support Azure Log Analytics V2 Alert Rules without prior knowledge of the product, requirements, or prior history of the project.
                      \end{itemize}
                    }
